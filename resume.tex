...
\begin{document}
    ...
    \section{Experience}
        % Cinsay
        \cventry{2013--Present}{PHP Engineer}{Cinsay, Inc.}{Dallas, TX/Austin, TX}{\httplink[http://cinsay.com/]{cinsay.com}}{Performed PHP web development in an SOA environment
        \begin{itemize}
