...
% moderncv themes
% Style options are 'casual' (default), 'classic', 'oldstyle' and 'banking'. I've
% added my own style with header customizations called 'classicklaude'.
\moderncvstyle{classicklaude}
% Color options 'blue' (default), 'orange', 'green', 'red', 'purple', 'grey' and
% 'black'. Grey is easiest for printing.
\moderncvcolor{grey}
...
\begin{document}
    ...
    \section{Knowledge}
        ...
        \cvitem{Frameworks}{jQuery, YUI,  Zend Framework, Symfony, Composer, Selenium}
        ...
        \cvitem{Programs}{git, subversion, phpunit,  Microsoft Office, LibreOffice, JIRA, FogBugz, dotProject, Wordpress, MediaWiki, vBulletin}
        \cvitem{Multimedia}{Adobe Photoshop, Adobe Illustrator, GIMP, iMovie, GarageBand, Ableton Live, ImageMagick}
        \cvitem{Concepts}{PHP, Perl, and Python best practices,l LAMP stack, development methodologies and best practices, remote API design and development, code design and deployment, MVC architecture, AJAX, systems and data security, functional and unit testing, datacenter and hardware management, local, wireless, and WAN networking, project management, gaming server administration}
    ...
    \section{Experience}
        % SingleHop
        \cventry{2012--Present}{Lead Developer}{SingleHop LLC}{Chicago, IL}{\httplink[http://singlehop.com/]{singlehop.com}}{Implemented development environments and standards
        \begin{itemize}
